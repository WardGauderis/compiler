...
BinaryOperation BinaryOperation::fromString(const std::string& str)
{
    if (str == "+") return BinaryOperation::Add;
        ...
        throw InternalError("unknown binary operation");
}

std::string BinaryOperation::string() const
{
    if (type == BinaryOperation::Add) return "+";
    else if (type == BinaryOperation::Sub)
        return "-";
    else if (type == BinaryOperation::Mul)
        return "*";
    else if (type == BinaryOperation::Div)
        return "/";
    else if (type == BinaryOperation::Mod)
        return "%";
    else if (type == BinaryOperation::Lt)
        return "<";
    else if (type == BinaryOperation::Gt)
        return ">";
    else if (type == BinaryOperation::Le)
        return "<=";
    else if (type == BinaryOperation::Ge)
        return ">=";
    else if (type == BinaryOperation::Eq)
        return "==";
    else if (type == BinaryOperation::Neq)
        return "!=";
    else if (type == BinaryOperation::And)
        return "&&";
    else if (type == BinaryOperation::Or)
        return "||";
    else
        throw InternalError("unknown binary operation");
}
...
PrefixOperation PrefixOperation::fromString(const std::string& str)
{
    if (str == "+") return PrefixOperation::Plus;
        ...
        return PrefixOperation::Neg;
    else if (str == "!")
        return PrefixOperation::Not;
    else if (str == "++")
...
std::string PrefixOperation::string() const
{
    ...
    else if (type == PrefixOperation::Neg)
        return "-";
    else if (type == PrefixOperation::Not)
        return "!";
    else if (type == PrefixOperation::Incr)
        return "++";
...
PostfixOperation PostfixOperation::fromString(const std::string& str)
{
    if (str == "++") return PostfixOperation::Incr;
        ...
        return PostfixOperation::Decr;
    else
        throw InternalError("unknown postfix operation string: " + str);
}

std::string PostfixOperation::string() const
{
    if (type == PostfixOperation::Incr) return "++";
    else if (type == PostfixOperation::Decr)
        return "--";
    else
        throw InternalError("unknown postfix operation");
}
