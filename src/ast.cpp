...
namespace {
	...
	template<typename Type0, typename Type1>
	Ast::Literal*
	fold_binary(Type0 lhs, Type1 rhs, const std::string& operation, std::shared_ptr<SymbolTable> table, size_t line,
			size_t column)
	{
	...
	template<typename Type>
	Ast::Literal*
	fold_unary(Type operand, const std::string& operation, std::shared_ptr<SymbolTable> table, size_t line,
			size_t column)
	{
	...
	template<typename Type>
	Ast::Literal* fold_cast(Type operand, const std::string& operation, std::shared_ptr<SymbolTable> table, size_t line,
			size_t column)
	{
